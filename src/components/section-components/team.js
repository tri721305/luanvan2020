...
class Team extends Component {
    ...
    return  <div className="team-newslater-bg" style={{backgroundImage: 'url('+publicUrl+'assets/img/bg/400.png)'}}>
			  {/* team area end */}
			      ...
			      <div className="row" style={{justifyContent: 'center'}}>
			        <div className="col-lg-3 col-sm-6">
			          <div className="single-team text-center">
			            ...
			            <h3 className="name"><a href="#">Minh Tri</a></h3>
			        ...
			        <div className="col-lg-3 col-sm-6">
			          <div className="single-team text-center">
			            ...
			            <h3 className="name"><a href="#">Thanh Huyen</a></h3>
			            <span>Creative Director</span>
			            <ul className="team-social">
			              <li><a href="#"><i className="fa fa-facebook" /></a></li>
			              <li><a href="#"><i className="fa fa-twitter" /></a></li>
