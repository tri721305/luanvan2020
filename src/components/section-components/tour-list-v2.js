                    ...
                    <div className="tour-list-area">
                      <div className="single-destinations-list style-three">
                        ...
                        <div className="details">
                          ...
                          <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Hội An</p>
                          <h4 className="title"><Link to="/tour-details">Phố cổ</Link></h4>
                      ...
                      <div className="single-destinations-list style-three">
                        ...
                        <div className="details">
                          ...
                          <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Hà Nội</p>
                          <h4 className="title"><Link to="/tour-details">Trung tâm thành phố HN</Link></h4>
                      ...
                      <div className="single-destinations-list style-three">
                        ...
                        <div className="details">
                          ...
                          <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Ninh Thuận</p>
                          <h4 className="title"><Link to="/tour-details">Amanoi</Link></h4>
                          <p className="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusa.</p>
                          <div className="list-price-meta">
                            <ul className="tp-list-meta d-inline-block">
                              <li><i className="fa fa-calendar-o" /> 10 Nov</li>
                      ...
                      <div className="single-destinations-list style-three">
                        ...
                        <div className="details">
                          ...
                          <p className="location"><img src={publicUrl+"assets/img/icons/1.png"} alt="map" />Đà Lạt</p>
                          <h4 className="title"><Link to="/tour-details">Hồ Tuyền Lâm</Link></h4>
                          <p className="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusa.</p>
                          <div className="list-price-meta">
                            <ul className="tp-list-meta d-inline-block">
                              <li><i className="fa fa-calendar-o" /> 10 Nov</li>
